...
class ConsoleTestCase(test.TestCase):
    ...
    def test_add_console(self):
        ...
        self.console.add_console(self.context, instance_uuid)
        ...
        self.assert_(instance_uuid in console_instances)
        db.instance_destroy(self.context, instance_uuid)

    def test_add_console_does_not_duplicate(self):
        instance_uuid = self._create_instance()
        cons1 = self.console.add_console(self.context, instance_uuid)
        cons2 = self.console.add_console(self.context, instance_uuid)
        self.assertEqual(cons1, cons2)
        db.instance_destroy(self.context, instance_uuid)

    def test_remove_console(self):
        instance_uuid = self._create_instance()
        console_id = self.console.add_console(self.context, instance_uuid)
